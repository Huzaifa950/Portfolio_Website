        ...
        <div className='progressBars' style={{ marginLeft: '20PX' }}>
          <div className="HTML">
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <p>HTML</p>
              <AiOutlineHtml5 style={{ color: '#FC4100', fontSize: '30px', fontWeight: 'bold' }} />
            </div>
            <SkillProgressBar now={80} label={80} />
          </div>
          ...
          <div className="HubSpot">
            ...
            <SkillProgressBar now={45} label={45} />
          </div>

        </div>
        <div className='description'>
          <p style={{ fontSize: '18px', fontWeight: '700', textDecoration: "underline" }}>Description</p>
          <p>
